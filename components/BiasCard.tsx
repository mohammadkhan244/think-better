    ...
    <div className="border border-[#2e2e2e] p-4 hover:border-[#c8a84b] transition-colors">
      <div className="flex items-start justify-between gap-2 mb-2">
        ...
        <div className="flex items-center gap-2 shrink-0">
          ...
          <span
            className="text-xs font-mono px-1.5 py-0.5 border"
            style={{ color: confidenceColors[confidence], borderColor: confidenceColors[confidence] }}
          >
            {confidence}
          </span>
        </div>
      ...
      <div className="flex items-start gap-2">
        <span className="text-xs text-[#444440] font-mono shrink-0">triggered by:</span>
